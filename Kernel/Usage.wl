...
FindSmallestFFLoop::usage = "\!\(\*RowBox[{\"FindSmallestFFLoop\", \"[\", StyleBox[\"expr\", \"TI\"], \"]\"}]\) \
identifies the smallest trace of structure constants in \!\(\*StyleBox[\"expr\", \"TI\"]\) \
...
EliminateInvariant::usage =
"Option of CIFARReduce that selects an invariant to eliminate from the final result using CF DF = TF DA. Valid values are CF, DF, TF, DA, and None. The default value is None.";
